...
## タスク: Phase 11.1 — macOS メニューバー

### 実装
- [ ] Step 1: Action enum に新バリアント追加 (SelectAll, Quit, About, Preferences)
- [ ] Step 2: handle_action メソッド抽出（event_loop.rs のリファクタリング）
- [ ] Step 3: muda クレート追加 + menu.rs 新規作成
- [ ] Step 4: SditEvent::MenuAction 追加 + SditApp に menu_id_map フィールド
- [ ] Step 5: main.rs でメニュー初期化 + MenuEvent ハンドラ設定
- [ ] Step 6: event_loop.rs で MenuAction ディスパッチ
- [ ] Step 7: SelectAll / Preferences / About / Quit の実装
- [ ] Step 8: #[cfg(target_os = "macos")] ガード
- [ ] Step 9: テスト追加
