...
## タスク: Phase 17.1〜17.4 — 品質・UX 向上バッチ

### Phase 17.1: テーマプリセット
- [x] 組み込みテーマ定義（Solarized Dark/Light, Dracula, Nord, One Dark, Tokyo Night）
- [x] テーマ切り替えアクション（NextTheme/PreviousTheme）+ 設定保存
- [x] テスト

### Phase 17.2: ウィンドウデコレーション設定
- [x] Config に decorations 設定追加 + winit 連携
- [x] Action::ToggleDecorations
- [x] テスト

### Phase 17.3: Always On Top
- [x] Config に always_on_top 設定追加 + winit 連携
- [x] Action::ToggleAlwaysOnTop
- [x] テスト

### Phase 17.4: 右クリック動作カスタマイズ
- [x] Config に right_click_action 設定追加
- [x] 右クリックハンドラー変更
- [x] テスト

### 品質ゲート
- [x] Stage 1（cargo fmt --check && cargo clippy --all-targets && cargo test 全通過）
- [x] Stage 2（セキュリティレビュー完了 — Critical/High/Medium なし）
- [x] 完了処理
